...
export default function OrdersMain() {
  ...
  const { newOrder, clearNewOrder, isConnected, pickupOtpReveal, clearPickupOtpReveal } = useRestaurantNotifications();
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      {/* Pickup OTP Reveal Popup - shows when rider presses "Request OTP" */}
      <AnimatePresence>
        {pickupOtpReveal && (
          <motion.div
