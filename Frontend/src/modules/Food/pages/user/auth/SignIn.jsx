...
export default function SignIn() {
  ...
  return (
    <AnimatedPage className="min-h-screen bg-[#FFFBF5] dark:bg-[#121212] flex items-center justify-center relative overflow-hidden">
      ...
      {/* Support Icon */}
      <Link to="/user/auth/support" className="absolute top-6 right-6 z-20 text-gray-400 hover:text-primary transition-colors flex items-center gap-1.5 font-medium text-sm">
